- Wiederhole rekursiv:
	...
	- Alle Elemente kleiner als p nach links, alle größer als p nach rechts (links und rechts ist nicht sortiert) 
		- Ein Zeiger sucht von links ausgehend die erste Stelle die größer als das Pivot ist, ein anderer Zeiger sucht von rechts ausgehend ein Element kleiner als das Pivot, die beiden werden getauscht. Und so weiter... 
