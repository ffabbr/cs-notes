...
Parallel speedup on **p** CPUs $$S_{p} = \frac{T_{1}}{T_{p}}$$
- $S_{p} = p$ : linear
- $S_{p} < p$ (sub-linear, performance loss)

Efficiency $$E=\frac{S_{p}}{p}$$
...
> Gustafson's Law can be seen as ==more work in the same time==, whereas Amdahl's Law would be ==same work but faster== need to happen. 